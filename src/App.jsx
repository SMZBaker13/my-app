...
// ─── Data ────────────────────────────────────────────────────────────────────
const CLINICS = [
  { id: 3, title: "All Skills", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, Apr 11", time: "3:45–5:15 PM", grade: "4th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", full: true, description: "Perfect entry point for middle schoolers building on core volleyball skills. We'll cover platform passing and serve receive positioning, as well as approach footwork and arm swing mechanics. We'll also integrate some fun games like queen of the court.", spotsLeft: true, icon: "🏐" },
  ...
  { id: 5, title: "Pre-Season Prep (Limit 5)", tag: "advanced", tagLabel: "Advanced", date: "Not Yet Scheduled", time: "3:45–5:15 PM", grade: "6th–8th Grade", location: "Lincoln Middle School", focus: "Full Skill Integration", registrations: [{ price: 50, priceUnit: "SMMUSD athlete", href: "mailto:opencourtathleticassociation@gmail.com", label: "Express Interest →" }, { price: 60, priceUnit: "Non-district athlete", href: "mailto:opencourtathleticassociation@gmail.com", label: "Express Interest →" }], description: "High-intensity session designed for players preparing for tryouts or upcoming school seasons. Competitive drills, serving mechanics, and game IQ. Limited to groups of 5 athletes.", icon: "🎯" },
          ...
          {visible.map(c => (
            <div className="clinic-card" key={c.id}>
              ...
              <div className="clinic-card-footer">
                {c.full ? (
                  <div style={{width:"100%", textAlign:"center", fontFamily:"'Playfair Display', serif", fontSize:"1.4rem", fontWeight:700, color:"var(--orange)", letterSpacing:"0.05em"}}>FULL</div>
                ) : c.registrations ? (

...
const CLINICS = [
  ...
  { id: 1, title: "All Skills", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, May 9", time: "3:45–5:15 PM", grade: "4th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", price: 35, description: "Perfect entry point for middle schoolers building on core volleyball skills. We'll cover platform passing and serve receive positioning, as well as approach footwork and arm swing mechanics. We'll also integrate some fun games like queen of the court.", icon: "🏐", buttonLabel: "Register →" },
  { id: 7, title: "All Skills", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, May 30", time: "3:45–5:15 PM", grade: "4th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", price: 35, description: "Perfect entry point for middle schoolers building on core volleyball skills. We'll cover platform passing and serve receive positioning, as well as approach footwork and arm swing mechanics. We'll also integrate some fun games like queen of the court.", icon: "🏐", buttonLabel: "Register →" },

...
// ─── Data ────────────────────────────────────────────────────────────────────
const CLINICS = [
  { id: 1, title: "All Skills + Guest Coach Olivier Ged", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, May 9", time: "3:45–5:15 PM", grade: "4th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", registrations: [{ price: 35, priceUnit: "SMMUSD athlete", href: "https://form.jotform.com/260528534420048" }, { price: 40, priceUnit: "Non-district athlete", href: "https://form.jotform.com/smzbaker/volleyball-clinic-registration---pr" }], description: "Perfect entry point for middle schoolers building on core volleyball skills. We'll cover platform passing and serve receive positioning, as well as approach footwork and arm swing mechanics. We'll also integrate some fun games like queen of the court.", boldSuffix: "This session will include OCAA Coach Patrick Gallagher, as well as Coach Olivier Ged who played as an Opposite at the college level for Université de Lyon and is a current head coach at a westside volleyball club.", icon: "🏐" },
  { id: 7, title: "All Skills + Guest Coach Olivier Ged", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, May 30", time: "3:45–5:15 PM", grade: "4th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", registrations: [{ price: 35, priceUnit: "SMMUSD athlete", href: "https://form.jotform.com/260528534420048" }, { price: 40, priceUnit: "Non-district athlete", href: "https://form.jotform.com/smzbaker/volleyball-clinic-registration---pr" }], description: "Perfect entry point for middle schoolers building on core volleyball skills. We'll cover platform passing and serve receive positioning, as well as approach footwork and arm swing mechanics. We'll also integrate some fun games like queen of the court.", boldSuffix: "This session will include OCAA Coach Patrick Gallagher, as well as Coach Olivier Ged who played as an Opposite at the college level for Université de Lyon and is a current head coach at a westside volleyball club.", icon: "🏐" },
  { id: 8, title: "All Skills + Guest Coach Olivier Ged", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, June 6", time: "3:45–5:15 PM", grade: "4th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", registrations: [{ price: 35, priceUnit: "SMMUSD athlete", href: "https://form.jotform.com/260528534420048" }, { price: 40, priceUnit: "Non-district athlete", href: "https://form.jotform.com/smzbaker/volleyball-clinic-registration---pr" }], description: "Perfect entry point for middle schoolers building on core volleyball skills. We'll cover platform passing and serve receive positioning, as well as approach footwork and arm swing mechanics. We'll also integrate some fun games like queen of the court.", boldSuffix: "This session will include OCAA Coach Patrick Gallagher, as well as Coach Olivier Ged who played as an Opposite at the college level for Université de Lyon and is a current head coach at a westside volleyball club.", icon: "🏐" },
  { id: 9, title: "All Skills + Guest Coach Olivier Ged", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, June 13", time: "3:45–5:15 PM", grade: "4th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", registrations: [{ price: 35, priceUnit: "SMMUSD athlete", href: "https://form.jotform.com/260528534420048" }, { price: 40, priceUnit: "Non-district athlete", href: "https://form.jotform.com/smzbaker/volleyball-clinic-registration---pr" }], description: "Perfect entry point for middle schoolers building on core volleyball skills. We'll cover platform passing and serve receive positioning, as well as approach footwork and arm swing mechanics. We'll also integrate some fun games like queen of the court.", boldSuffix: "This session will include OCAA Coach Patrick Gallagher, as well as Coach Olivier Ged who played as an Opposite at the college level for Université de Lyon and is a current head coach at a westside volleyball club.", icon: "🏐" },
  { id: 4, title: "Elementary Intro", tag: "beginner", tagLabel: "Beginner", date: "Not Yet Scheduled", time: "3:45–5:15 PM", grade: "2nd–5th Grade", location: "Lincoln Middle School", focus: "Basic Skills & Fun", price: 25, priceUnit: "SMMUSD athlete", description: "A fun, welcoming introduction to volleyball for younger athletes. Emphasis on enthusiasm, basic ball control, and building a love for the sport.", icon: "⭐", buttonLabel: "Express Interest →" },
  { id: 5, title: "Elite Skills Lab (Limit 6)", tag: "advanced", tagLabel: "Advanced", date: "Saturday, May 16", time: "3:45–5:15 PM", grade: "6th–8th Grade", location: "Lincoln Middle School", focus: "Full Skill Integration", registrations: [{ price: 50, priceUnit: "SMMUSD athlete", href: "mailto:opencourtathleticassociation@gmail.com", label: "Express Interest →" }, { price: 60, priceUnit: "Non-district athlete", href: "mailto:opencourtathleticassociation@gmail.com", label: "Express Interest →" }], description: "Designed for experienced players competing at the club level or returning to school teams. Small-group format focused on refining technical skills, reading the game, and executing under pressure. Limited to 6 athletes for maximum reps and individualized coaching.", bullets: ["Serving Techniques: Short serves, deep corners, seam targeting", "Passing & Defense: Reading hitter approach and shoulder cues", "Hitting: Arm swing mechanics and placement (line, angle, tipping, roll shots)"], icon: "🎯" },
        ...
        <div className="clinics-grid">
          {visible.map(c => (
            <div className="clinic-card" key={c.id}>
              ...
              <div className="clinic-card-body"><p>{c.description}{c.boldSuffix && <> <strong>{c.boldSuffix}</strong></>}</p>{c.bullets && <ul style={{marginTop:8, paddingLeft:18}}>{c.bullets.map((b,i) => <li key={i} style={{fontSize:"0.9rem", color:"var(--muted)", fontWeight:300, lineHeight:1.65, marginBottom:4}}>{b}</li>)}</ul>}{c.spotsLeft && <p><strong><em>Only a few spots left!</em></strong></p>}</div>
              <div className="clinic-card-footer">
                {c.full ? (
                  <div style={{width:"100%", textAlign:"center", fontFamily:"'Playfair Display', serif", fontSize:"1.1rem", fontWeight:700, color:"var(--orange)"}}>This clinic is now full.</div>
                ) : c.registrations ? (
                  <div style={{display:"flex", flexDirection:"column", gap:12, width:"100%"}}>
                    {c.registrations.map((r, i) => (
                      <div key={i} style={{display:"flex", justifyContent:"space-between", alignItems:"center"}}>
                        <div className="clinic-price">${r.price} <span>/ {r.priceUnit}</span></div>
                        <a className="btn-register" href={r.href} target={r.href.startsWith("mailto:") ? undefined : "_blank"} rel={r.href.startsWith("mailto:") ? undefined : "noopener noreferrer"}>{r.label || "Register →"}</a>
                      </div>
                    ))}
                  </div>
                ) : (

...
// ─── Data ────────────────────────────────────────────────────────────────────
const CLINICS = [
  { id: 15, title: "Middle School Volleyball Skills", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, September 19", time: "3:45–5:15 PM", grade: "6th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", registrations: [{ price: 10, priceUnit: "SMMUSD athlete", href: "https://pci.jotform.com/form/260528534420048" }], description: "This clinic covers key volleyball skills and tips for Middle School volleyball players. We'll work on serve receive and positioning, serving technique and consistency, setting fundamentals, and approach footwork and hitting mechanics.", icon: "🏐" },
  { id: 16, title: "Middle School Volleyball Skills", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, September 26", time: "3:45–5:15 PM", grade: "6th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", registrations: [{ price: 10, priceUnit: "SMMUSD athlete", href: "https://pci.jotform.com/form/260528534420048" }], description: "This clinic covers key volleyball skills and tips for Middle School volleyball players. We'll work on serve receive and positioning, serving technique and consistency, setting fundamentals, and approach footwork and hitting mechanics.", icon: "🏐" },
  { id: 17, title: "Middle School Volleyball Skills", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, October 10", time: "3:45–5:15 PM", grade: "6th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", registrations: [{ price: 10, priceUnit: "SMMUSD athlete", href: "https://pci.jotform.com/form/260528534420048" }], description: "This clinic covers key volleyball skills and tips for Middle School volleyball players. We'll work on serve receive and positioning, serving technique and consistency, setting fundamentals, and approach footwork and hitting mechanics.", icon: "🏐" },
  { id: 18, title: "Middle School Volleyball Skills", tag: "intermediate", tagLabel: "Intermediate", date: "Sat, October 17", time: "3:45–5:15 PM", grade: "6th–8th Grade (co-ed)", location: "Lincoln Middle School", focus: "All Skills", registrations: [{ price: 10, priceUnit: "SMMUSD athlete", href: "https://pci.jotform.com/form/260528534420048" }], description: "This clinic covers key volleyball skills and tips for Middle School volleyball players. We'll work on serve receive and positioning, serving technique and consistency, setting fundamentals, and approach footwork and hitting mechanics.", icon: "🏐" },
  { id: 4, title: "Elementary Intro", tag: "beginner", tagLabel: "Beginner", date: "Not Yet Scheduled", time: "3:45–5:15 PM", grade: "2nd–5th Grade", location: "Lincoln Middle School", focus: "Basic Skills & Fun", price: 15, priceUnit: "SMMUSD athlete", description: "A fun, welcoming introduction to volleyball for younger athletes. Emphasis on enthusiasm, basic ball control, and building a love for the sport.", icon: "⭐", buttonLabel: "Express Interest →" },
];
const TESTIMONIALS = [
